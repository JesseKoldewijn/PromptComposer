...
| Sheet    | Key            | Prompt / body   |
|----------|----------------|-----------------|
| Subjects | Excel row 2    | `BODY_ALPHA`    |
| Outfits  | Outfit L1-01   | `OUTFIT_1_1`    |
| Poses    | Pose L2-01     | `POSE_2_1`      |
| Actions  | Action L1-02   | `ACTION_1_2`    |
| Scenes   | Scene L3-01    | `SCENE_3_1`     |
